                    ...
                    <c:forEach items="${allOrders}" var="o" varStatus="status">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px" width="60%">
                                ...
                                <table border="1" width="100%" cellspacing="0" style="background: #66afe9">
                                    <!--
            ...
            if (txt == "订单详情") {
                ...
                $.post(url, obj, function (data) {
                    ...
                    $.each(data, function (i, obj) {
                        // alert(i + " ; " + obj)
                        var td="<tr><td><img src='${pageContext.request.contextPath}/" + obj.product.pimage + "' width='50px'/></td><td><a target='_blank' href='${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=" + obj.product.pid + "'>" + obj.product.pname + "</a></td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
                        $tb.append(td);
                    })
                }, "json");
